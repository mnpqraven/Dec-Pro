...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname Auf6-2) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
;Aufgabe 6-2
; [X,Y,Z] (X -> Y) (Y -> Z) -> (X -> Z)
